    ...
    <main class="min-h-screen">
        ...
        <section class="relative mt-12">
          ...
          >
            ...
            >
              <h5 class="font-medium text-[#1E2B4F]">Dr. Bayu Cakra Aditya</h5>
                ...
                <div class="flex flex-wrap gap-16 mt-8">
                  <div class="flex items-center gap-4">
                    <div class="flex-shrink-0">
                      <img
                        src="/assets/frontsite/images/service.svg"
                        alt="service icon"
                      />
                    </div>
                    <div>
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 lg:gap-10 mt-10">
              <a href="{{ route('appointment.index') }}" class="group">
                <div class="relative z-10 w-full h-[350px] rounded-2xl overflow-hidden">
                  <img src="/assets/frontsite/images/doctor-1.png" class="w-full h-full bg-center bg-no-repeat object-cover object-center" alt="Doctor 1">
              ...
              <a href="{{ route('appointment.index') }}" class="group">
                <div class="relative z-10 w-full h-[350px] rounded-2xl overflow-hidden">
                  <img src="/assets/frontsite/images/doctor-2.png" class="w-full h-full bg-center bg-no-repeat object-cover object-center" alt="Doctor 1">
                  <div class="opacity-0 group-hover:opacity-100 transition-all ease-in absolute inset-0 bg-[#0D63F3] bg-opacity-70 flex justify-center items-center">
                    <span class="text-[#0D63F3] font-medium bg-white rounded-full px-8 py-3">Book Now</span>
                  </div>
                </div>
              ...
              <a href="{{ route('appointment.index') }}" class="group">
                <div class="relative z-10 w-full h-[350px] rounded-2xl overflow-hidden">
                  <img src="/assets/frontsite/images/doctor-3.png" class="w-full h-full bg-center bg-no-repeat object-cover object-center" alt="Doctor 1">
                  <div class="opacity-0 group-hover:opacity-100 transition-all ease-in absolute inset-0 bg-[#0D63F3] bg-opacity-70 flex justify-center items-center">
                    <span class="text-[#0D63F3] font-medium bg-white rounded-full px-8 py-3">Book Now</span>
                  </div>
                </div>
